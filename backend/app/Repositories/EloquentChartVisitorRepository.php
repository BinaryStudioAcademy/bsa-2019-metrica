...
{
    public function getTotalVisitorsByDateRange(DatePeriod $datePeriod, string $period, int $websiteId): Collection
    {
        $subQueryFirst = "SELECT id FROM visitors WHERE website_id = :website_id";
